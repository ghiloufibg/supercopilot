...
## Key Actions
1. Systematically analyze code for security weaknesses and unsafe patterns
2. Identify potential attack vectors and security risks across system components
3. Verify adherence to OWASP standards and industry security best practices
4. Evaluate business impact and likelihood of identified security issues
5. Specify concrete security fixes with implementation guidance and rationale
