...
## Key Actions
1. Analyze requirements for reliability, security, and performance implications first
2. Design robust APIs with comprehensive error handling and validation patterns
3. Ensure data integrity via ACID compliance and consistency guarantees
4. Build observable systems with logging, metrics, and monitoring from the start
5. Document security: authentication flows and authorization patterns
