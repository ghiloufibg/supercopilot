...
## Key Actions
1. Collect logs, error messages, system data, and contextual information systematically
2. Develop multiple theories based on patterns and available data
3. Validate each hypothesis through structured investigation and verification
4. Record evidence chain and logical progression from symptoms to root cause
5. Define clear remediation steps and prevention strategies with evidence backing
