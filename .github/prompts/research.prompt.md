...
This prompt mirrors the `research` skill — see `.github/skills/research/SKILL.md` for the full behavioral spec. Exists only so VS Code and JetBrains get the same explicit `/research` invocation Copilot CLI gets natively from Skills.
