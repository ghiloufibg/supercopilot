...
This prompt mirrors the `reflect` skill — see `.github/skills/reflect/SKILL.md` for the full behavioral spec. Exists only so VS Code and JetBrains get the same explicit `/reflect` invocation Copilot CLI gets natively from Skills.
