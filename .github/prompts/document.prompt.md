...
This prompt mirrors the `document` skill — see `.github/skills/document/SKILL.md` for the full behavioral spec. Exists only so VS Code and JetBrains get the same explicit `/document` invocation Copilot CLI gets natively from Skills.
