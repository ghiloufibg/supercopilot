...
This prompt mirrors the `analyze` skill — see `.github/skills/analyze/SKILL.md` for the full behavioral spec. Exists only so VS Code and JetBrains get the same explicit `/analyze` invocation Copilot CLI gets natively from Skills.
