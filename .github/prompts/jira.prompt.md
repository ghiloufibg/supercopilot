...
This prompt mirrors the `jira` skill — see `.github/skills/jira/SKILL.md` for the full behavioral spec. Exists only so VS Code and JetBrains get the same explicit `/jira` invocation Copilot CLI gets natively from Skills.
