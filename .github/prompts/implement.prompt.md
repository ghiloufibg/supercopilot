...
This prompt mirrors the `implement` skill — see `.github/skills/implement/SKILL.md` for the full behavioral spec. Exists only so VS Code and JetBrains get the same explicit `/implement` invocation Copilot CLI gets natively from Skills.
