...
This prompt mirrors the `design` skill — see `.github/skills/design/SKILL.md` for the full behavioral spec. Exists only so VS Code and JetBrains get the same explicit `/design` invocation Copilot CLI gets natively from Skills.
...
**Will Not:**
- Generate actual implementation code (use `implement`)
