...
This prompt mirrors the `troubleshoot` skill — see `.github/skills/troubleshoot/SKILL.md` for the full behavioral spec. Exists only so VS Code and JetBrains get the same explicit `/troubleshoot` invocation Copilot CLI gets natively from Skills.
