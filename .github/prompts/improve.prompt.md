...
This prompt mirrors the `improve` skill — see `.github/skills/improve/SKILL.md` for the full behavioral spec. Exists only so VS Code and JetBrains get the same explicit `/improve` invocation Copilot CLI gets natively from Skills.
